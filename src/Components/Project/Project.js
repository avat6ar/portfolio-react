...
import "./Project.css";
import { arrProjects } from "./api/arrProjects";
const Project = () => {
  return (
    <Fragment>
      <div className="experience">
        <div className="row align-items-center justify-content-between">
          <div className="col-md-6 fadeInLeft">
            ...
            <ProgressBar animated now={90} className="progress-1" />
            <div className="item my-2">
            ...
            <ProgressBar animated now={85} className="progress-2" />
            <div className="item my-2">
            ...
            <ProgressBar animated now={90} className="progress-4" />
            <div className="item my-2">
            ...
            <ProgressBar animated now={80} className="progress-3" />
            <div className="item my-2">
            ...
            <ProgressBar animated now={70} className="progress-5" />
          </div>
          <div className="col-md-5 fadeInRight">
            <div className="experience_img">
              <img src={experience} alt="" className="img-fluid" />
            </div>
          </div>
          <div className="col-12 text-center">
            <h5 className="m-0 mt-2 h5">Scroll Down</h5>
            <div className="scrol_item">
